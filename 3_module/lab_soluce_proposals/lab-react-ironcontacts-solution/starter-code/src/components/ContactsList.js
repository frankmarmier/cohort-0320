    ...
    showContacts(){
        return this.state.firstVisibleContacts.map((eachContact, index)=>{
          return (
            <tr key={index}>
                <td> 
                    <img className="img-fluid img-thumbnail celebImg" src={eachContact.pictureUrl} alt={eachContact.name +" photo"} /> 
                </td>
                <td>
                    {eachContact.name}
                </td>
      ...
      render() {
        return (
          ...
          <h1>IronContacts <span role="img" aria-label="heart"> ❤️ </span></h1>
